...
static EC_GROUP* GsCreateEcGroup(GostR3410Params* params, BN_CTX* ctx)
{
    ...
    if (!BN_hex2bn(&p, params->p) || !BN_hex2bn(&a, params->a) || !BN_hex2bn(&b, params->b))
    {
        return NULL;
    }
...
static int GsSetEcGenerator(EC_GROUP* group, GostR3410Params* params, BN_CTX* ctx)
{
    ...
    if (!BN_hex2bn(&x, params->x) || !BN_hex2bn(&y, params->y) || !BN_hex2bn(&q, params->q) ||
